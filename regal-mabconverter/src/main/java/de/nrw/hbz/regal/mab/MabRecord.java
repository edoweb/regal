...
public class MabRecord {
    ...
    /*-
    	10             Indikatorlaenge
     */
    public char indikatorlaenge;
    /*-
    	11             Teilfeldkennungslaenge
     */
    public char teilfeldkennungslaenge;
    /*-
    ...
    /*-
    	026       REGIONALE IDENTIFIKATIONSNUMMER
    	          ...
    	          h     = Gemeinsamer Bibliotheksverbund der Laender Bremen,
    	                  ...
    	                  (ab 1996)
     */
    public String regionaleId = null;
    /*-
     ...
     */
    public final String angabenZumDatensatz = "a|1uc||||||||";
    /*-
     ...
     */
    public String identifizierungsmerkmalInstitution = "929";
    /*-
     ...
     * 078
     */
    public final String edowebMarker = "hbz-edoweb";
    /*-
    ...
    public enum KennzeichnungAmtlicherDruckschriften {
	Regierungsbezirksebene, nationalstaatlicheEbene, internationaleEbene, Kreis, lokaleEbene, mehrereAmtlicheKoerperschaften, KoerperschaftOeffentlichenRechts, Region, Land, sonstige
    }

    public enum Literaturtyp {
	Fachbuch, Kinderbuch, Lehrbuch, populaerwissenschaftlicheLiteratur, Belletristik, Trivialliteratur, wissenschaftlicheLiteratur, Sonstiges
    }

    public enum Veroeffentlichungsart {
	Abstract, Bibliographie, Katalog, Woerterbuch, Enzyklopaedie, Festschrift, Datenbank, Biographie, Registerwerk, Fortschrittsbericht, Konferenzschrift, Gesetz, Musikalia, Normschrift, Loseblattausgabe, Patentdokument, Lieferungswerk, Report, Statistik, Aufsatz, Universitaetsschrift, Sonderdruck, Schulbuch, sonstige
    }

    public enum Erscheinungsform {
	unselbststaendig, fortsetzung, einbaendig, merbaendig, einbaendigTeil, merbaendigTeil
    }

    public class VeroeffentlichungsSpezifischeAngaben {
	public Erscheinungsform erscheinungsform;
	public Veroeffentlichungsart veroeffentlichungsart;
	public Literaturtyp literaturtyp;
	public boolean reprintMarker;
	public KennzeichnungAmtlicherDruckschriften kennzeichnungAmtlicherDruckschriften;
    }

    public enum PersonType {
	natuerlichePerson, koerperschaft
    }

    public enum PersonRole {
	author, herausgeber, drucker
    }
