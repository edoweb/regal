...
public class FileResource {
    ...
    /**
     * @throws IOException
     *             if resources are misconfigured
     */
    ...
    /**
     * @param pid
     *            the pid, e.g. uuid for the resource
     * @param namespace
    ...
    /**
     * @return list of all file resources
     */
    @GET
    @Produces({ "application/json", "application/xml" })
    ...
    /**
     * @return list of all file resources as html
     */
    @GET
    @Produces({ "text/html" })
    public Response getAllAsHtml() {
	String rem = resources.getAllOfTypeAsHtml(ObjectType.file.toString());
