...
/**
 * Fedora Vocabulary encapsulates some fedora specific names those are used for data modelling and data retrieval.
...
public abstract class FedoraVocabulary
{
	...
	// TODO Design issue
	/**
	 * The namespace of all relations used for default fedora objects: See: https://wiki.duraspace.org/display/FEDORA34/Fedora+Digital+Object+Model
	 */
	public final static String INFO_NAMESPACE = "info:fedora/";// "http://127.0.0.1:8080/fedora/objects/";

	/**
	 * The namespace of all fedora relations. See: http://www.fedora.info/definitions/1/0/fedora-relsext-ontology.rdfs
	 */
	...
	/**
	 * See: https://wiki.duraspace.org/display/FEDORA34/Fedora+Digital+Object+Model
	 */
