...
/**
 * 
 * Example mapping with metafacture
 * 
 */
public class MyMapping {
    final static Logger logger = LoggerFactory.getLogger(MyMapping.class);
	...
	File fluxFile = createFile("my-xmetadissplus-to-lobid.flux",
		"/tmp/my-xmetadissplus-to-lobid.flux");
	createFile("my-xmetadissplus-to-lobid.xml",
		"/tmp/my-xmetadissplus-to-lobid.xml");
