 ...
 *  you may not use this supplement except in compliance with the License.
...
public class Supplement {
    ...
    /**
     * @throws IOException
     *             if resources initialise wrong
     */
    public Supplement() throws IOException {
	...
	return resources.deleteAllOfType(ObjectType.supplement.toString());
    }
	...
	input.type = ObjectType.supplement.toString();
	...
	return resources.getAllOfType(ObjectType.supplement.toString());
    }

    /**
     * @return a list of all supplements as html
     */
    @GET
    @Produces({ "text/html" })
